          ...
          <div className="flex flex-col gap-4 my-8">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  key={index}
                  className={`border py-2 px-4 bg-gray-100 hover:bg-gray-50 ${item === size ? 'border-orange-500' : ''}`}
                  onClick={() => onButtonClickHandler(item)}
                >
                  {item}
                </button>
              ))}
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            transactions without the need for a physical oresence. E-commerce
